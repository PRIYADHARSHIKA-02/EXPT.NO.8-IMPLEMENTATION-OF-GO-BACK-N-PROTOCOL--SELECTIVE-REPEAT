...
# AIM:
To write and execute a program for the Go-Back-N protocol-Selective Repeat.
# EQUIPMENTS REQUIRED:
...
---
# RESULT:
Thus, write and execute a program for the Go-Back-N protocol-Selective Repeat.
